...
*/
#ifndef _MM_433SENSORS_h
#define _MM_433SENSORS_h

// Ensure RC Switch hasn't been defined already
#ifdef _RCSwitch_h
  #error This library replaces RCSwitch for the FizzJelly platform
#endif
